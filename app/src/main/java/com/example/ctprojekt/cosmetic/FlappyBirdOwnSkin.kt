...
class FlappyBirdOwnSkin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_flappy_bird_own_skin)
        filename = "coins.txt"
        var settings = AuthUI.getApplicationContext().getSharedPreferences(filename, 0)
        val editor = settings.edit()
        var rgbSnake = settings.getInt("BirdFlapOwnSkin", Color.argb(255,255,255,255))
        val hexColorSnake = java.lang.Integer.toHexString(rgbSnake)
        val hexColorBackground = java.lang.Integer.toHexString(settings.getInt("BackgroundFlapOwnSkin", Color.argb(255,255,255,255)))
        val hexColorApple = java.lang.Integer.toHexString(settings.getInt("PillarFlapOwnSkin", Color.argb(255,255,255,255)))
    ...
    fun onClick(view: View){
        var settings = AuthUI.getApplicationContext().getSharedPreferences(filename, 0)
        val editor = settings.edit()
        editor.putInt("BirdFlapOwnSkin", Color.rgb(tvSnakeColorRed.text.toString().toInt(), tvSnakeColorGreen.text.toString().toInt(), tvSnakeColorBlue.text.toString().toInt()))
        editor.putInt("BackgroundFlapOwnSkin", Color.rgb(tvBackgroundColorRed.text.toString().toInt(), tvBackgroundColorGreen.text.toString().toInt(), tvBackgroundColorBlue.text.toString().toInt()))
        editor.putInt("PillarFlapOwnSkin", Color.rgb(tvAppleColorRed.text.toString().toInt(), tvAppleColorGreen.text.toString().toInt(), tvAppleColorBlue.text.toString().toInt()))
        editor.apply()
        finish()
    }
    fun lul(view: View){
